...
In polyphony (figurative or mensural music), these aspects come
together. It will become obvious, that meter is a universal principle,
independent of a specific language.

To perfect the production of music, three aspects need to be observed:

1. Pitch and intonation
2. Rhythm
3. Meter

In the sixth book we will discuss whether the second and third aspect
can be treated as one. For now we will start with pitch though.
...
** Chapter 4, Is music mathematical or not?
As discussed, music is neither purely abstract (only in the domain of
numbers) nor purely sensual (only in the domain of sound), but a third
thing that consists of a combination of both. We call this /sonorous
number/ ('numerus sonorus').
